...
public class GPUImageFilterTools {
  ...
  public static GPUImageFilter createFilterForType(final Context context, final FilterType type) {
    ...
    switch (type) {
      ...
      case ACV_AIMEI:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.aimei));
        return curveFilter;
      case ACV_DANLAN:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.danlan));
        return curveFilter;
      case ACV_DANHUANG:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.danhuang));
        return curveFilter;
      case ACV_FUGU:
      ...
      case ACV_GAOLENG:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.gaoleng));
        return curveFilter;
      case ACV_HUAIJIU:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.huaijiu));
        return curveFilter;
      case ACV_JIAOPIAN:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.jiaopian));
        return curveFilter;
      case ACV_KEAI:
      ...
      case ACV_MORENJIAQIANG:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.morenjiaqiang));
        return curveFilter;
      case ACV_NUANXIN:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.nuanxin));
        return curveFilter;
      case ACV_QINGXIN:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.qingxin));
        return curveFilter;
      case ACV_RIXI:
      ...
      case ACV_02:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.tow));
        return curveFilter;
      case ACV_06:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.six));
        return curveFilter;
      case ACV_17:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.shiqi));
        return curveFilter;
      case ACV_AQUA:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.aqua));
        return curveFilter;
      case ACV_CROSSPROCESS:
        curveFilter.setFromCurveFileInputStream(
            context.getResources().openRawResource(R.raw.crossprocess));
        return curveFilter;
      case ACV_PURPLE_GREEN:
        curveFilter.setFromCurveFileInputStream(
  ...
  public enum FilterType {
    ...
    ACV_KEAI, ACV_LOMO, ACV_MORENJIAQIANG, ACV_NUANXIN, ACV_QINGXIN, ACV_RIXI, ACV_WENNUAN, CONTRAST,
    ACV_02, ACV_06, ACV_17, ACV_AQUA, ACV_CROSSPROCESS, ACV_PURPLE_GREEN, ACV_YELLO_RED,
    GRAYSCALE, SHARPEN, SEPIA, SOBEL_EDGE_DETECTION, THREE_X_THREE_CONVOLUTION, FILTER_GROUP, EMBOSS,
    POSTERIZE, GAMMA, BRIGHTNESS, INVERT, HUE, PIXELATION, SATURATION, EXPOSURE, HIGHLIGHT_SHADOW,
    MONOCHROME, OPACITY, RGB, WHITE_BALANCE, VIGNETTE, TONE_CURVE, BLEND_COLOR_BURN,
  ...
  public static class FilterAdjuster {
    ...
    private abstract class Adjuster<T extends GPUImageFilter> {
      ...
      @SuppressWarnings("unchecked") public Adjuster<T> filter(final GPUImageFilter filter) {
    ...
    private class SharpnessAdjuster extends Adjuster<GPUImageSharpenFilter> {
      @Override public void adjust(final int percentage) {
    ...
    private class ColorBalanceAdjuster extends Adjuster<GPUImageColorBalanceFilter> {
      ...
      @Override public void adjust(int percentage) {
        getFilter().setMidtones(new float[] {
            range(percentage, 0.0f, 1.0f), range(percentage / 2, 0.0f, 1.0f),
