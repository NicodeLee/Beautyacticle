...
//        addItem(new DividerItem(this));
        ...
        long cacheSize = FileUtil.getDirectorySize(APP.getInstance().imageLoader.getDiskCache().getDirectory());
        final TextItem clearImageItem = new TextItem(this, "key2");
        addItem(clearImageItem
                .setTitle("清除图片（重启生效）")
...
//        addItem(new DividerItem(this));
        ...
        addItem(new TextItem(this, "key4").setTitle("作者").setSubtitle("感谢使用@By Nicodelee").setOnclick(new TextItem.OnClickListener() {
            @Override
            public void onClick(TextItem v) {
